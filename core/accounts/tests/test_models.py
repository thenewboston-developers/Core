...
def test_account_send(recipient_account, recipient_account_number):
    ...
    send_mock.assert_called_once_with(
        MessageType.UPDATE_ACCOUNT, recipient_account.account_number, {'balance': recipient_account.balance}
    )
